...
public class BoardService {
    ...
    public void save(BoardDTO boardDTO) throws IOException {
        ...
        if (boardDTO.getBoardFile().isEmpty()) {
             ...
             * 1. DTO에 담긴 파일을 꺼냄
             * 2. 파일의 이름 가져옴
             * 3. 서버 저장용 이름을 만듦 (사진.jpg => 846548945614_사진.jpg)
             * 4. 저장 경로 설정
             * 5. 해당 경로에 파일 저장
            ...
            for (MultipartFile boardFile : boardDTO.getBoardFile()) {
                ...
                String savePath = "C:/Users/{username}/Downloads/" + storedFileName; // 4
    ...
    public Page<BoardDTO> paging(Pageable pageable) {
        ...
        int pageLimit = 3; // 한 페이지에 보여줄 게시글의 개수
        ...
        System.out.println("boardEntities.getContent() = " + boardEntities.getContent()); // 요청 페이지에 해당하는 게시글
        System.out.println("boardEntities.getTotalElements() = " + boardEntities.getTotalElements()); // 전체 게시글 수
        System.out.println("boardEntities.getNumber() = " + boardEntities.getNumber()); // DB로 요청한 페이지 번호
        System.out.println("boardEntities.getTotalPages() = " + boardEntities.getTotalPages()); // 전체 페이지 수
        System.out.println("boardEntities.getSize() = " + boardEntities.getSize()); // 한 페이지에 보여지는 게시글 수
